...
st.markdown("""
This app uses advanced statistical models, including Poisson distribution, correct score odds, and more to predict the most realistic halftime/full-time correct scores.
It aims to beat the bookmakers with precise calculations for maximum margin and ROI.
""")
